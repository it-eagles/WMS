...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <!------- /. Import Goods ------->
                    ...
                    <div class="active tab-pane" id="importfiles">
                     <!-- Post -->
               <div class="row">
         ...
         <!-- right column -->
             ...
             <!-----/ Export Goods----->
              ...
              <%-----------------------------------------------------------END Assign Detail Of Pull Signal TAB----------------------------------------------------------%>
                         ...
                         <%-----------------------------------------------------Start PICK/PACK TAB-----------------------------------------------------------%>
             <!------- Import Goods ------->
            <div class="active tab-pane" id="pickpack">
                     <!-- Post -->
               <div class="row">
                        <%-----------------------------------------------------Start JOB Form-----------------------------------------------------------%>
                   <div class="col-lg-12 col-md-12 ">
 ...
 <!------- /. Import Goods ------->
                         ...
                         <%-----------------------------------------------------Start PICK NJR TAB-----------------------------------------------------------%>
             <!------- Import Goods ------->
            <div class="active tab-pane" id="picknjr">
                     <!-- Post -->
               <div class="row">
                        <%-----------------------------------------------------Start JOB Form-----------------------------------------------------------%>
                   <div class="col-lg-12 col-md-12 ">
 ...
 <!------- /. Import Goods ------->
             ...
             <!------- Import Goods ------->
            <div class="active tab-pane" id="pickautopallet">
                     <!-- Post -->
               <div class="row">
                        <%-----------------------------------------------------Start JOB Form-----------------------------------------------------------%>
                   <div class="col-lg-12 col-md-12 ">
