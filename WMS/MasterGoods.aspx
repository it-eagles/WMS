<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="MasterGoods.aspx.vb" MasterPageFile="~/Home.Master" Inherits="WMS.MasterGoods" EnableEventValidation="false" EnableViewState="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="form1" runat="server">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-2">
                                                ...
                                                <button type="button" class="btn btn-bitbucket btn-sm" id="btnSearchProduct" runat="server" onserverclick="btnSearchProduct_ServerClick" visible="false"><i class="glyphicon glyphicon-search"></i></button>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                                ...
                                                <div class="form-horizontal">
                                                    ...
                                                    <div class="box-body">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtMinimunStock" runat="server" placeholder="Minimun Stock" autocomplete="off" value ="0"/>
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtAdjustment" runat="server" placeholder="Adjustment" autocomplete="off" value ="0" />
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtDamageQty" runat="server" placeholder="Damage Qty" autocomplete="off" value ="0" />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtAvailableQTY" runat="server" placeholder="Available QTY" autocomplete="off" value ="0" />
                                                            </div>
                                                    ...
                                                    <div class="box-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-1">
                                                                <div class="checkbox">
                                                                    <label>
                                                                        <input type="checkbox" runat="server" id="chkImpEnable1" onclick="EnableDisableControls();" />
                                                                        Enable
                                                                    </label>
                                                                </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-1">
                                                                <div class="checkbox">
                                                                    <label>
                                                                        <input type="checkbox" runat="server" id="chkImpEnable2" onclick="chkImpEnable2();" />
                                                                        Enable
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-1">
                                                                <div class="checkbox">
                                                                    <label>
                                                                        <input type="checkbox" runat="server" id="chkImpEnable3" onclick="chkImpEnable3();" />
                                                                        Enable
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-lg-6 col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input class="form-control input-sm" id="txtImpValueRateP" runat="server" placeholder="Value Rate" autocomplete="off"  value ="0"/>
                                                                </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input class="form-control input-sm" id="txtImpSpecificRateP" runat="server" placeholder="Specific Rate" autocomplete="off"  value ="0"/>
                                                                </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input class="form-control input-sm" id="txtImpSurchargeRate" runat="server" placeholder="Surcharge Rate" autocomplete="off" value ="0" />
                                                                </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input class="form-control input-sm" id="txtImpExciseRate" runat="server" placeholder="Excise Rate" autocomplete="off"  value ="0"/>
                                                                </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input class="form-control input-sm" id="txtImpExciseSpcRate" runat="server" placeholder="Excise Spc Rate" autocomplete="off"  value ="0"/>
                                                                </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input class="form-control input-sm" id="txtImpExemptExcise" runat="server" placeholder="Excise" autocomplete="off" value ="0" />
                                                                </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input class="form-control input-sm" id="txtImpValueRate" runat="server" placeholder="Value Rate" autocomplete="off" value ="0" />
                                                                </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input class="form-control input-sm" id="txtImpValueRateAmount" runat="server" placeholder="Value Rate Amount" autocomplete="off"  value ="0"/>
                                                                </div>
                                                        ...
                                                        <div class="col-lg-6 col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input class="form-control input-sm" id="txtImpSpeciticRate" runat="server" placeholder="Specitic Rate" autocomplete="off" value ="0" />
                                                                </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input class="form-control input-sm" id="txtImpSpecificCal" runat="server" placeholder="Specific Cal" autocomplete="off"  value ="0"/>
                                                                </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input class="form-control input-sm" id="txtImpExemptVat" runat="server" placeholder="Exempt Vat" autocomplete="off"  value ="0"/>
                                                                </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input class="form-control input-sm" id="txtImpExciseNo" runat="server" placeholder="Excise No" autocomplete="off"  value ="0"/>
                                                                </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input class="form-control input-sm" id="txtImpExciseRatePay" runat="server" placeholder="Excise Rate Pay " autocomplete="off"  value ="0"/>
                                                                </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input class="form-control input-sm" id="txtImpExciseSpcRatePay" runat="server" placeholder="Excise Spc Rate Pay" autocomplete="off" value ="0" />
                                                                </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <input class="form-control input-sm" id="txtImpExchangeRate" runat="server" placeholder="Currency" autocomplete="off" value ="0" />
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="box-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-1">
                                                                <div class="checkbox">
                                                                    <label>
                                                                        <input type="checkbox" runat="server" id="chkExpEnable1" onclick="chkExpEnable1();" />
                                                                        Enable
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-1">
                                                                <div class="checkbox">
                                                                    <label>
                                                                        <input type="checkbox" runat="server" id="chkExpEnable2" onclick="chkExpEnable2();" />
                                                                        Enable
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-1">
                                                                <div class="checkbox">
                                                                    <label>
                                                                        <input type="checkbox" runat="server" id="chkExpEnable3" onclick="chkExpEnable3();" />
                                                                        Enable
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-lg-6 col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input class="form-control input-sm" id="txtExpQtyCarton" runat="server" placeholder="Qty Carton" autocomplete="off"  value ="0"/>
                                                                </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input class="form-control input-sm" id="txtExpWeightCarton" runat="server" placeholder="Weight/Carton" autocomplete="off" value ="0" />
                                                                </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input class="form-control input-sm" id="txtExpValueRate" runat="server" placeholder="Value Rate" autocomplete="off" value ="0" />
                                                                </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input class="form-control input-sm" id="txtExpValueRateAmount" runat="server" placeholder="Value Rate Amount" autocomplete="off"  value ="0"/>
                                                                </div>
                                                        ...
                                                        <div class="col-lg-6 col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input class="form-control input-sm" id="txtExpPriceForeight" runat="server" placeholder="Foreight" autocomplete="off"  value ="0"/>
                                                                </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input class="form-control input-sm" id="txtExpQtyPallet" runat="server" placeholder="QTY/PALLET " autocomplete="off" value ="0" />
                                                                </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <input class="form-control input-sm" id="txtExpExchangeRate" runat="server" placeholder="Currency" autocomplete="off" value ="0" />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-lg-12 col-md-12 col-md-offset-2">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-2">
                                                                        ...
                                                                        <input class="form-control input-sm" id="txtProductWidth" runat="server" placeholder="Width" autocomplete="off"  value ="0.0"/>
                                                                    </div>

                                                                    <div class="col-md-2">
                                                                        <label for="txtProductHeight">Heigh</label>
                                                                        <input class="form-control input-sm" id="txtProductHeight" runat="server" placeholder="Height" autocomplete="off" value ="0.0"/>
                                                                    </div>

                                                                    <div class="col-md-2">
                                                                        <label for="txtProductLeng">length</label>
                                                                        <input class="form-control input-sm" id="txtProductLeng" runat="server" placeholder="length" autocomplete="off" value ="0.0"/>
                                                                    </div>
                                                                    <div class="col-md-2">
                                                                        <label for="txtProductVolume">Volume</label>
                                                                        <input class="form-control input-sm" id="txtProductVolume" runat="server" placeholder="Volume" autocomplete="off" value ="0.0" />
                                                                    </div>
                                                                    <div class="col-md-2 p-t-24">
                                                                        <label for="txtProductVolume"> </label>
                                                            ...
                                                            <div class="col-lg-12 col-md-12 col-md-offset-2">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-2">
                                                                        ...
                                                                        <input class="form-control input-sm" id="txtPackageWidth" runat="server" placeholder="Width" autocomplete="off" value ="0.0"/>
                                                                    </div>

                                                                    <div class="col-md-2">
                                                                        <label for="txtPackageHeigh">Heigh</label>
                                                                        <input class="form-control input-sm" id="txtPackageHeigh" runat="server" placeholder="Height" autocomplete="off" value ="0.0"/>
                                                                    </div>

                                                                    <div class="col-md-2">
                                                                        <label for="txtPackageLenght">length</label>
                                                                        <input class="form-control input-sm" id="txtPackageLenght" runat="server" placeholder="length" autocomplete="off" value ="0.0" />
                                                                    </div>
                                                                    <div class="col-md-2">
                                                                        <label for="txtPackageCarton">No of Carton</label>
                                                                        <input class="form-control input-sm" id="txtPackageCarton" runat="server" placeholder="Volume" autocomplete="off" value ="0.0"/>
                                                                    </div>
                                                            ...
                                                            <div class="col-lg-12 col-md-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        ...
                                                                        <input class="form-control input-sm" id="txtPackageVolume" runat="server" placeholder="Volume" autocomplete="off" value ="0.0" />
                                                    ...
                                                    <div class="box-body">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input class="form-control input-sm" id="txtEAS" runat="server" placeholder="EAS P/N"  autocomplete="off" />                                                                    
                                                                </div>
                                                                <div class="col-md-2">
                                                                <button type="button" class="btn btn-primary btn-sm" id="btnEAS" runat="server" onserverclick="btnEAS_ServerClick"><i class="glyphicon glyphicon-search"></i></button>
                                                                    </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <input class="form-control input-sm" id="txtCustomer" runat="server" placeholder="Customer"  autocomplete="off" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <input class="form-control input-sm" id="txtOwner" runat="server" placeholder="Owner"  autocomplete="off" />
                                                                </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <input class="form-control input-sm" id="txtQty" runat="server" placeholder="Quality"  autocomplete="off" />
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-offset-9">
                                                                <button type="submit" runat="server" class="btn btn-primary" id="btnAddAssembly" title="btnAddAssembly" onserverclick="btnAddAssembly_ServerClick">Add</button>
                                                                <button type="submit" runat="server" class="btn btn-primary" id="btnModifyAssembly" title="btnModifyAssembly" onserverclick="btnModifyAssembly_ServerClick">Modify</button>
                                                                <button type="submit" runat="server" class="btn btn-primary" id="btnDeleteAssembly" title="btnDeleteAssembly" onserverclick="btnDeleteAssembly_ServerClick">Delete</button>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="col-lg-12 col-xs-12">
                                            ...
                                            <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand">
                                                    ...
                                                    <table id="example1" class="table table-striped table-condensed">
                                                        <thead>
                                                            <tr>
                                                                <th>Select</th>
                                                                <th>ProductCode</th>
                                                                <th>SubProductCode</th>
                                                                <th>ImpProductAttribute1</th>
                                                                <th>Customer</th>
                                                                <th>Owner</th>
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        <td class="text-center">
                                                                        <asp:LinkButton ID="LinkButton2" CssClass="btn bg-navy  btn-sm" runat="server" CausesValidation="False" CommandName="SelectdataSubProductCode" CommandArgument='<%# Eval("SubProductCode")%>'><i class="fa fa-hand-o-up"></i></asp:LinkButton>
                                                                    </td>
                                                        <td>
                                                            <asp:Label ID="lblProductCode" runat="server" Text='<%# Bind("ProductCode")%>'></asp:Label></td>
                                                        <td>
                                                            <asp:Label ID="lblSubProductCode" runat="server" Text='<%# Bind("SubProductCode")%>'></asp:Label></td>
                                                        <td>
                                                            <asp:Label ID="lblImpProductAttribute1" runat="server" Text='<%# Bind("ImpProductAttribute1")%>'></asp:Label></td>
                                                        <td>
                                                            <asp:Label ID="lblCustomer" runat="server" Text='<%# Bind("Customer")%>'></asp:Label></td>
                                                        <td>
                                                            <asp:Label ID="lblOwner" runat="server" Text='<%# Bind("Owner")%>'></asp:Label></td>
                                                        <td>
                                                            <asp:Label ID="lblQuantityProduct" runat="server" Text='<%# Bind("QuantityProduct")%>'></asp:Label></td>
                                                    </tr>
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Label ID="lblProductCode" runat="server" Text='<%# Bind("ProductCode")%>'></asp:Label></td>
                                                        <td>
                                                            <asp:Label ID="lblCustomerCode" runat="server" Text='<%# Bind("CustomerPart")%>'></asp:Label></td>
                                                        <td>
                                                            <asp:Label ID="lblEndUserPart" runat="server" Text='<%# Bind("EndUserPart")%>'></asp:Label></td>
                                                        <td>
                                                            <asp:Label ID="lblImpDesc1" runat="server" Text='<%# Bind("ImpDesc1")%>'></asp:Label></td>
                                                    </tr>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <tfoot>
        ...
        <!-- Modal EAS-->
        <asp:Panel ID="EASPanel" runat="server" CssClass="modal" TabIndex="-1" role="dialog" aria-labelledby="myLabe1">
            <div class="modal-dialog modal-lg" role="dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="exampleModalLabelll">Select EAS</h4>
                    </div>
                    <asp:UpdatePanel ID="EASUpdatePanel" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <div class="modal-body">
                                <section class="content">
                                    <form class="form-horizontal">
                                        <div class="col-lg-12 col-md-12 " style="overflow: auto;">
                                            ...
                                            <asp:Repeater ID="Repeater2" runat="server" OnItemCommand="Repeater2_ItemCommand">
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        <td class="text-center">
                                                            <asp:LinkButton ID="LinkButton1" CssClass="btn bg-navy btn-sm" runat="server" CausesValidation="False" CommandName="selectProductCodeee" CommandArgument='<%# Eval("ProductCode")%>'><i class="fa fa-hand-o-up"></i></asp:LinkButton>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="lblProductCode" runat="server" Text='<%# Bind("ProductCode")%>'></asp:Label></td>
                                                        <td>
                                                            <asp:Label ID="lblPONo" runat="server" Text='<%# Bind("PONo")%>'></asp:Label></td>
                                                        <td>
                                                            <asp:Label ID="lblCustomerPart" runat="server" Text='<%# Bind("CustomerPart")%>'></asp:Label></td>
                                                        <td>
                                                            <asp:Label ID="lblEndUserPart" runat="server" Text='<%# Bind("EndUserPart")%>'></asp:Label></td>
                                                    </tr>
                                                </ItemTemplate>
