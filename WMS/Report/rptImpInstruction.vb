...
Public Class rptImpInstruction
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WMS.rptImpInstruction.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptImpInstruction
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptImpInstruction = New rptImpInstruction()
        rpt.Site = Me.Site
        Return rpt
    End Function
