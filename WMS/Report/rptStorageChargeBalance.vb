...
Public Class rptStorageChargeBalance
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptStorageChargeBalance.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WMS.rptStorageChargeBalance.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_vBalance() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptStorageChargeBalance
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStorageChargeBalance = New rptStorageChargeBalance()
        rpt.Site = Me.Site
        Return rpt
    End Function
