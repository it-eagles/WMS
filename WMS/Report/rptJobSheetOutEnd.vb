...
Public Class rptJobSheetOutEnd
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WMS.rptJobSheetOutEnd.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptJobSheetOutEnd
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptJobSheetOutEnd = New rptJobSheetOutEnd()
        rpt.Site = Me.Site
        Return rpt
    End Function
