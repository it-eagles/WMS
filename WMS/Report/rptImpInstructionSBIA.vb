...
Public Class rptImpInstructionSBIA
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptImpInstructionSBIA.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WMS.rptImpInstructionSBIA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptImpInstructionSBIA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptImpInstructionSBIA = New rptImpInstructionSBIA()
        rpt.Site = Me.Site
        Return rpt
    End Function
