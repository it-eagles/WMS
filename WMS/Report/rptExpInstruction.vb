...
Public Class rptExpInstruction
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WMS.rptExpInstruction.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptExpInstruction
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptExpInstruction = New rptExpInstruction()
        rpt.Site = Me.Site
        Return rpt
    End Function
