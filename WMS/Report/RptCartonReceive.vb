...
Public Class RptCartonReceive
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WMS.RptCartonReceive.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptCartonReceive
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptCartonReceive = New RptCartonReceive()
        rpt.Site = Me.Site
        Return rpt
    End Function
