...
Public Class ExpCustomsInvoice
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WMS.ExpCustomsInvoice.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedExpCustomsInvoice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ExpCustomsInvoice = New ExpCustomsInvoice()
        rpt.Site = Me.Site
        Return rpt
    End Function
