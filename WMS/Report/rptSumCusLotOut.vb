...
Public Class rptSumCusLotOut
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WMS.rptSumCusLotOut.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSumCusLotOut
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSumCusLotOut = New rptSumCusLotOut()
        rpt.Site = Me.Site
        Return rpt
    End Function
