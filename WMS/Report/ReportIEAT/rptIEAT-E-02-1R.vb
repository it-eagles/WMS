...
Public Class rptIEAT_E_02_1R
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WMS.rptIEAT-E-02-1R.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptIEAT_E_02_1R
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptIEAT_E_02_1R = New rptIEAT_E_02_1R()
        rpt.Site = Me.Site
        Return rpt
    End Function
