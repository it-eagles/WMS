...
Public Class rptJobSheetInEnd
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WMS.rptJobSheetInEnd.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptJobSheetInEnd
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptJobSheetInEnd = New rptJobSheetInEnd()
        rpt.Site = Me.Site
        Return rpt
    End Function
