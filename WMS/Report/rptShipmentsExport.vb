...
Public Class rptShipmentsExport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WMS.rptShipmentsExport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptShipmentsExport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptShipmentsExport = New rptShipmentsExport()
        rpt.Site = Me.Site
        Return rpt
    End Function
