...
Public Class HTISummary_Issue
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WMS.HTISummary_Issue.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedHTISummary_Issue
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As HTISummary_Issue = New HTISummary_Issue()
        rpt.Site = Me.Site
        Return rpt
    End Function
