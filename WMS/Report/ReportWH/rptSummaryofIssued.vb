...
Public Class rptSummaryofIssued
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WMS.rptSummaryofIssued.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSummaryofIssued
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSummaryofIssued = New rptSummaryofIssued()
        rpt.Site = Me.Site
        Return rpt
    End Function
