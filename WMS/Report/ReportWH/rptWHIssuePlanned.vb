...
Public Class rptWHIssuePlanned
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WMS.rptWHIssuePlanned.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptWHIssuePlanned
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptWHIssuePlanned = New rptWHIssuePlanned()
        rpt.Site = Me.Site
        Return rpt
    End Function
