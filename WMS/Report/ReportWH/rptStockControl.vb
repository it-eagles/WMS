...
Public Class rptStockControl
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WMS.rptStockControl.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStockControl
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStockControl = New rptStockControl()
        rpt.Site = Me.Site
        Return rpt
    End Function
