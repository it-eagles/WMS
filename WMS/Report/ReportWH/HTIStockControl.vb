...
Public Class HTIStockControl
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WMS.HTIStockControl.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedHTIStockControl
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As HTIStockControl = New HTIStockControl()
        rpt.Site = Me.Site
        Return rpt
    End Function
