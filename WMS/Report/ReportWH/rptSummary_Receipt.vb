...
Public Class rptSummary_Receipt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WMS.rptSummary_Receipt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSummary_Receipt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSummary_Receipt = New rptSummary_Receipt()
        rpt.Site = Me.Site
        Return rpt
    End Function
