...
Public Class HTIPhysicalCount
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WMS.HTIPhysicalCount.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_WHSite() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedHTIPhysicalCount
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As HTIPhysicalCount = New HTIPhysicalCount()
        rpt.Site = Me.Site
        Return rpt
    End Function
