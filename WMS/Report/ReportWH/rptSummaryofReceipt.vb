...
Public Class rptSummaryofReceipt
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptSummaryofReceipt.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WMS.rptSummaryofReceipt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSummaryofReceipt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSummaryofReceipt = New rptSummaryofReceipt()
        rpt.Site = Me.Site
        Return rpt
    End Function
