...
Public Class rptSummary_Issue
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WMS.rptSummary_Issue.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSummary_Issue
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSummary_Issue = New rptSummary_Issue()
        rpt.Site = Me.Site
        Return rpt
    End Function
