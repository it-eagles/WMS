...
Public Class HTISummary_Unpick
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WMS.HTISummary_Unpick.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedHTISummary_Unpick
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As HTISummary_Unpick = New HTISummary_Unpick()
        rpt.Site = Me.Site
        Return rpt
    End Function
