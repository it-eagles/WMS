...
Public Class rptSummaryJOBOut
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WMS.rptSummaryJOBOut.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSummaryJOBOut
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSummaryJOBOut = New rptSummaryJOBOut()
        rpt.Site = Me.Site
        Return rpt
    End Function
