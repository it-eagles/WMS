...
Public Class RptLogShippingMark
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WMS.RptLogShippingMark.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptLogShippingMark
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptLogShippingMark = New RptLogShippingMark()
        rpt.Site = Me.Site
        Return rpt
    End Function
