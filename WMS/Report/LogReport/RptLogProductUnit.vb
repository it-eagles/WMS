...
Public Class RptLogProductUnit
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WMS.RptLogProductUnit.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptLogProductUnit
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptLogProductUnit = New RptLogProductUnit()
        rpt.Site = Me.Site
        Return rpt
    End Function
