...
Public Class RptLogCarLicense
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WMS.RptLogCarLicense.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptLogCarLicense
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptLogCarLicense = New RptLogCarLicense()
        rpt.Site = Me.Site
        Return rpt
    End Function
