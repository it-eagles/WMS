...
Public Class RptLogImpInvoice
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WMS.RptLogImpInvoice.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptLogImpInvoice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptLogImpInvoice = New RptLogImpInvoice()
        rpt.Site = Me.Site
        Return rpt
    End Function
