...
Public Class RptLogImpInvoiceDetail
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RptLogImpInvoiceDetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WMS.RptLogImpInvoiceDetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptLogImpInvoiceDetail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptLogImpInvoiceDetail = New RptLogImpInvoiceDetail()
        rpt.Site = Me.Site
        Return rpt
    End Function
