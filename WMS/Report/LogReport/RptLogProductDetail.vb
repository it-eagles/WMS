...
Public Class RptLogProductDetail
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RptLogProductDetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WMS.RptLogProductDetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptLogProductDetail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptLogProductDetail = New RptLogProductDetail()
        rpt.Site = Me.Site
        Return rpt
    End Function
