...
Public Class RptLogReferenceType
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RptLogReferenceType.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WMS.RptLogReferenceType.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptLogReferenceType
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptLogReferenceType = New RptLogReferenceType()
        rpt.Site = Me.Site
        Return rpt
    End Function
