...
Public Class RptLogConsignnee
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WMS.RptLogConsignnee.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptLogConsignnee
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptLogConsignnee = New RptLogConsignnee()
        rpt.Site = Me.Site
        Return rpt
    End Function
