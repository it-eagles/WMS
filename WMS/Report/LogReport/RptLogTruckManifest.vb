...
Public Class RptLogTruckManifest
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RptLogTruckManifest.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WMS.RptLogTruckManifest.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptLogTruckManifest
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptLogTruckManifest = New RptLogTruckManifest()
        rpt.Site = Me.Site
        Return rpt
    End Function
