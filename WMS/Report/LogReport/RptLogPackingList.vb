...
Public Class RptLogPackingList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WMS.RptLogPackingList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptLogPackingList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptLogPackingList = New RptLogPackingList()
        rpt.Site = Me.Site
        Return rpt
    End Function
