...
Public Class RptLogTruckWayBill
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WMS.RptLogTruckWayBill.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptLogTruckWayBill
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptLogTruckWayBill = New RptLogTruckWayBill()
        rpt.Site = Me.Site
        Return rpt
    End Function
