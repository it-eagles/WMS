...
Public Class RptLogTruckOwner
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WMS.RptLogTruckOwner.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptLogTruckOwner
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptLogTruckOwner = New RptLogTruckOwner()
        rpt.Site = Me.Site
        Return rpt
    End Function
