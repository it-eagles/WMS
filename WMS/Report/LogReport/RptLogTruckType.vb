...
Public Class RptLogTruckType
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WMS.RptLogTruckType.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptLogTruckType
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptLogTruckType = New RptLogTruckType()
        rpt.Site = Me.Site
        Return rpt
    End Function
