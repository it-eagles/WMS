...
Public Class RptLogDeliveryTerm
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WMS.RptLogDeliveryTerm.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptLogDeliveryTerm
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptLogDeliveryTerm = New RptLogDeliveryTerm()
        rpt.Site = Me.Site
        Return rpt
    End Function
