                                ...
                                <div class="col-md-12 col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input class="form-control" id="Text1" runat="server" autocomplete="off" />
                                        </div>

                                        <div class="col-md-3">
                                            <label for="txtTruckWayBill">JOB No</label>
                                            <input class="form-control" id="Text2" runat="server" autocomplete="off" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-horizontal">
                                            <fieldset>
                                                ...
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        <label for="txtItemNo_ItemDetail" class="col-sm-2 control-label">Item No:</label>
                                                        <div class="col-sm-4">
                                                            <input class="form-control" id="txtItemNo_ItemDetail" runat="server" />
                                                        </div>
                                                        <label for="txtProductCode_ItemDetail" class="col-sm-2 control-label">ProductCode:</label>
                                                        <div class="col-sm-4">
