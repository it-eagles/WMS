<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SingleReceivedWH.aspx.vb" Inherits="WMS.SingleReceivedWH" MasterPageFile="~/Home.Master" EnableEventValidation="false" %>
                                            ...
                                            <div class="box-body">
                                                <fieldset runat="server" id="confirmgoodreceive_">
                                                    ...
                                                    <div class="col-md-12 col-lg-12">
                                                        <div class="col-md-4 col-sm-4">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-7">
                                                                    ...
                                                                    <input runat="server" id="txtLotNo_" class="form-control" autocomplete="off" type="text" />
                                                                </div>
                                                                <div class="col-md-2">
                                                                    <button runat="server" class="btn btn-primary " type="button" onserverclick="btnSeletJobNew_ServerClick" id="btnSeletJobNew"><i class="fa fa-search"></i></button>
                                                                    <button runat="server" class="btn  btn-danger" type="button" onserverclick="btnSelectJobEdit_ServerClick" id="btnSelectJobEdit"><i class="fa fa-search"></i></button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label for="txtCustomerLot" class="col-sm-4 control-label">Cust REF No:</label>
                                                                <div class="col-sm-8">
                                                                    <input class="form-control" id="txtCustomerLot" runat="server" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!-- /.box-header -->
                                                            ...
                                                            <fieldset>
                                                                ...
                                                                <div class="box-body">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-sm-6">
                                                                            <input runat="server" id="txtOwnerCode" class="form-control" type="text" autocomplete="off" />
                                                                            <%-- <asp:DropDownList ID="ddlOwnerCode_ConGoodRec" CssClass="form-control" runat="server"></asp:DropDownList>--%>
                                                                        </div>
                                                                        <div class="col-sm-2">
                                                                            <button runat="server" class="btn btn-primary btn-block" type="button" onserverclick="Unnamed_ServerClick"><i class="fa fa-search"></i></button>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="txtOwnerEng" class="col-sm-4 control-label">Name:</label>
                                                                        <div class="col-sm-8">
                                                                            <input class="form-control" id="txtOwnerEng" runat="server" />
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="txtOwnerStreet_Number" class="col-sm-4 control-label">Address1:</label>
                                                                        <div class="col-sm-8">
                                                                            <input class="form-control" id="txtOwnerStreet_Number" runat="server" />
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="txtOwnerDistrict" class="col-sm-4 control-label">Address2:</label>
                                                                        <div class="col-sm-8">
                                                                            <input class="form-control" id="txtOwnerDistrict" runat="server" />
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="txtOwnerSubProvince" class="col-sm-4 control-label">Address3:</label>
                                                                        <div class="col-sm-8">
                                                                            <input class="form-control" id="txtOwnerSubProvince" runat="server" />
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="txtOwnerProvince" class="col-sm-4 control-label">Address4:</label>
                                                                        <div class="col-sm-8">
                                                                            <input class="form-control" id="txtOwnerProvince" runat="server" />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <!-- /.box-body -->
                                                                ...
                                                                <div class="box-body">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-sm-6">
                                                                            ...
                                                                            <input runat="server" id="txtBrokerCode" class="form-control" type="text" autocomplete="off" />
                                                                        </div>
                                                                        <div class="col-md-2">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <input class="form-control" id="txtBrokerNameEng" runat="server" />
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="txtBrokerStreet" class="col-sm-4 control-label">Address1:</label>
                                                                        <div class="col-sm-8">
                                                                            <input class="form-control" id="txtBrokerStreet" runat="server" />
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="txtBrokerDistrict" class="col-sm-4 control-label">Address2:</label>
                                                                        <div class="col-sm-8">
                                                                            <input class="form-control" id="txtBrokerDistrict" runat="server" />
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="txtBrokerSubProvince" class="col-sm-4 control-label">Address3:</label>
                                                                        <div class="col-sm-8">
                                                                            <input class="form-control" id="txtBrokerSubProvince" runat="server" />
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="txtBrokerProvince" class="col-sm-4 control-label">Address4:</label>
                                                                        <div class="col-sm-8">
                                                                            <input class="form-control" id="txtBrokerProvince" runat="server" />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <!-- /.box-body -->
                                                            ...
                                                            <fieldset>
                                                                ...
                                                                <div class="box-body">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <asp:DropDownList ID="dolCommodity" CssClass="form-control" runat="server"></asp:DropDownList>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="dcbQuantity2" class="col-sm-5 control-label">Quantity Package:</label>
                                                                        <div class="col-sm-3">
                                                                            <input class="form-control" id="txtQuantityPackage" runat="server" value="0.0" />
                                                                        </div>
                                                                        <div class="col-sm-4">
                                                                            <asp:DropDownList ID="dcbQuantity2" CssClass="form-control" runat="server"></asp:DropDownList>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="txtQuantityPLTSkid_ConGoodRec" class="col-sm-5 control-label">Quantity PLT/Skid:</label>
                                                                        <div class="col-sm-3">
                                                                            <input class="form-control" id="txtPLT" runat="server" value="0.0" />
                                                                        </div>
                                                                        <div class="col-sm-4">
                                                                            <asp:DropDownList ID="dcbPLT" CssClass="form-control" runat="server"></asp:DropDownList>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="txtQuantityReceived_ConGoodRec" class="col-sm-5 control-label">Quantity Received:</label>
                                                                        <div class="col-sm-3">
                                                                            <input class="form-control" id="txtQtyReceived" runat="server" value="0.0" />
                                                                        </div>
                                                                        <div class="col-sm-4">
                                                                            <asp:DropDownList ID="cboReceivedUNIT" CssClass="form-control" runat="server"></asp:DropDownList>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="txtQuantityDamage_ConGoodRec" class="col-sm-5 control-label">Quantity Damage:</label>
                                                                        <div class="col-sm-3">
                                                                            <input class="form-control" id="txtQtyDamage" runat="server" value="0.0" />
                                                                        </div>
                                                                        <div class="col-sm-4">
                                                                            <asp:DropDownList ID="cboDamageUNIT" CssClass="form-control" runat="server"></asp:DropDownList>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                ...
                                                                <div class="box-body">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-sm-6">
                                                                            ...
                                                                            <input runat="server" id="txtConsigneeCode_" class="form-control" type="text" autocomplete="off">
                                                                        </div>
                                                                        <div class="col-md-2">
                                                            ...
                                                            <fieldset>
                                                                ...
                                                                <div class="box-body">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-sm-6">
                                                                            <input runat="server" id="txtExporterCode" class="form-control" autocomplete="off" type="text" />
                                                                        </div>
                                                                        <div class="col-md-2">
                                                            ...
                                                            <fieldset>
                                                                ...
                                                                <div class="box-body">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-sm-4">
                                                                            <asp:DropDownList ID="dcbQuantity1" CssClass="form-control" runat="server"></asp:DropDownList>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-sm-4">
                                                                            <asp:DropDownList ID="dcbWeight" CssClass="form-control" runat="server"></asp:DropDownList>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-sm-4">
                                                                            <asp:DropDownList ID="dcbVolume" CssClass="form-control" runat="server"></asp:DropDownList>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="txtQTYWaitRec_ConGoodRec" class="col-sm-5 control-label">QTY Wait Receive:</label>
                                                                        <div class="col-sm-3">
                                                                            <input class="form-control" id="txtQtyWaitReceive" runat="server" value="0.0" />
                                                                        </div>
                                                                        <div class="col-sm-4">
                                                                            <asp:DropDownList ID="cboWaitReceiveUNIT" CssClass="form-control" runat="server"></asp:DropDownList>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="txtQTYDiscrepancy_ConGoodRec" class="col-sm-5 control-label">QTY Discrepancy:</label>
                                                                        <div class="col-sm-3">
                                                                            <input class="form-control" id="txtQtyDiscrepancy" runat="server" value="0.0" />
                                                                        </div>
                                                                        <div class="col-sm-4">
                                                                            <asp:DropDownList ID="cboDiscrepencyUNIT" CssClass="form-control" runat="server"></asp:DropDownList>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <!-- /.box-body -->
                                                ...
                                                <fieldset runat="server" id="goodreceivedetail_">
                                                    ...
                                                    <div class="col-md-4 col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <asp:DropDownList ID="dcbSite" CssClass="form-control" runat="server"></asp:DropDownList>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <asp:DropDownList ID="dcbLocation" CssClass="form-control" runat="server"></asp:DropDownList>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="txtCustWHFac_GoodRecDetail" class="col-sm-4 control-label">Cust W/H Fac:</label>
                                                            <div class="col-sm-8">
                                                                <asp:DropDownList ID="dcbSource" CssClass="form-control" runat="server"></asp:DropDownList>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-horizontal">
                                                            ...
                                                            <div class="box-body">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <asp:DropDownList ID="dcbType" CssClass="form-control" runat="server">
                                                                            <asp:ListItem></asp:ListItem>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <asp:DropDownList ID="dcbTypeDamage" CssClass="form-control" runat="server">
                                                                            <asp:ListItem></asp:ListItem>
                                                ...
                                                <fieldset runat="server" id="putaway_">
                                                    ...
                                                    <div class="col-md-4 col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <asp:DropDownList ID="dcbSite1" CssClass="form-control" runat="server"></asp:DropDownList>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <asp:DropDownList ID="dcbLocation1" CssClass="form-control" runat="server"></asp:DropDownList>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                        ...
                                        <div class="col-lg-12 col-md-12 " style="overflow: auto;">
                                            ...
                                            <asp:Repeater ID="dgvOwner" runat="server" OnItemDataBound="dgvOwner_ItemDataBound">
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        <td class="text-center">
                                                            <asp:LinkButton ID="lnkPartyCode_Owner" CssClass="btn bg-navy" runat="server" OnClick="lnkPartyCode_Owner_Click"><i class="fa fa-hand-o-up"></i></asp:LinkButton>
                                                        </td>
                                                        <td>
                                        ...
                                        <div class="col-lg-12 col-md-12 " style="overflow: auto;">
                                            ...
                                            <asp:Repeater ID="dgvBroker" runat="server" OnItemDataBound="dgvBroker_ItemDataBound">
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        <td class="text-center">
                                                            <asp:LinkButton ID="lnkPartyCode_Broker" CssClass="btn bg-navy" runat="server" OnClick="lnkPartyCode_Broker_Click"><i class="fa fa-hand-o-up"></i></asp:LinkButton>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="lblPartyCode" runat="server" Text="Label"></asp:Label></td>
                                                        <td>
                                    ...
                                    <form class="form-horizontal">
                                        <div class="col-lg-12 col-md-12 " style="overflow: auto;">
                                            ...
                                            <asp:Repeater ID="dgvExporterCode" runat="server" OnItemDataBound="dgvExporterCode_ItemDataBound">
                                                ...
                                                <ItemTemplate>
                                                    <td class="text-center">
                                                        <asp:LinkButton ID="lnkPartyCode_Ex" CssClass="btn bg-navy" runat="server" OnClick="lnkPartyCode_Ex_Click"><i class="fa fa-hand-o-up"></i></asp:LinkButton>
                                                    </td>
                                                    <td>
                                                        <asp:Label ID="lblPartyCode" runat="server" Text="Label"></asp:Label></td>
                                                    <td>
                                    ...
                                    <form class="form-horizontal">
                                        <div class="col-lg-12 col-md-12 " style="overflow: auto;">
                                            ...
                                            <asp:Repeater ID="dgvPrepire" runat="server" OnItemDataBound="dgvPrepire_ItemDataBound">
                                                ...
                                                <ItemTemplate>
                                                    <td class="text-center">
                                                        <asp:LinkButton ID="lnkPartyCode_LOTNo" CssClass="btn bg-navy" runat="server" OnClick="lnkPartyCode_LOTNo_Click"><i class="fa fa-hand-o-up"></i></asp:LinkButton>
                                                    </td>
                                                    <td>
                                    ...
                                    <form class="form-horizontal">
                                        <div class="col-lg-12 col-md-12 " style="overflow: auto;">
                                            ...
                                            <asp:Repeater ID="dgvPickUp" runat="server">
                                                ...
                                                <ItemTemplate>
                                                    <td class="text-center">
                                                        <asp:LinkButton ID="lnkPartyCode_pick" CssClass="btn bg-navy" runat="server"><i class="fa fa-hand-o-up"></i></asp:LinkButton>
                                                    </td>
                                                    <td>
                                                        <asp:Label ID="lblPartyCode" runat="server" Text="Label"></asp:Label></td>
                                                    <td>
                                    ...
                                    <form class="form-horizontal">
                                        <div class="col-lg-12 col-md-12 " style="overflow: auto;">
                                            ...
                                            <asp:Repeater ID="dgvEndCus" runat="server">
                                                ...
                                                <ItemTemplate>
                                                    <td class="text-center">
                                                        <asp:LinkButton ID="lnkPartyCode_End" CssClass="btn bg-navy" runat="server"><i class="fa fa-hand-o-up"></i></asp:LinkButton>
                                                    </td>
                                                    <td>
                                                        <asp:Label ID="lblPartyCode" runat="server" Text="Label"></asp:Label></td>
                                                    <td>
                                        ...
                                        <div class="col-lg-12 col-md-12 " style="overflow: auto;">
                                            ...
                                            <asp:Repeater ID="dgvCustomerGroup" runat="server">
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        <td class="text-center">
                                                            <asp:LinkButton ID="lnkPartyCode_Group" CssClass="btn bg-navy" runat="server"><i class="fa fa-hand-o-up"></i></asp:LinkButton>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="lblPartyCode" runat="server" Text="Label"></asp:Label></td>
