                                                ...
                                                <div class="col-lg-12">
                                                    <div class="col-md-5 col-lg-5">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <input class="form-control input-sm" id="txtLotNo" runat="server" placeholder="JOB NO" autofocus="autofocus" autocomplete="off" />
                                                            </div>
                                                            <div class="col-sm-2">
                                                                <button runat="server" class="btn btn-primary btn-sm" type="button" onserverclick="Unnamed_ServerClick" id="btnSeletJob"><i class="fa fa-search"></i></button>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-5">
                                                                <asp:DropDownList ID="cboJobSite" CssClass="form-control input-sm" runat="server" DataTextField="Code" DataValueField="Code">
                                                                </asp:DropDownList>
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <div class="checkbox">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-7">
                                                                <div class="input-group date">
                                                                    ...
                                                                    <asp:TextBox CssClass="form-control input-sm" ID="dtpInvoiceDate" runat="server" placeholder="MM/DD/YYYY" autocomplete="off">
                                                                    </asp:TextBox>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-7">
                                                                <asp:DropDownList ID="dcbSales" CssClass="form-control input-sm" runat="server" DataTextField="Code" DataValueField="Code" AutoPostBack="true" OnSelectedIndexChanged="dcbSales_SelectedIndexChanged"></asp:DropDownList>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-7">
                                                                <asp:DropDownList ID="ComboBox2" CssClass="form-control input-sm" runat="server">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-md-11">
                                                                <input class="form-control pull-right input-sm" id="txtSalesName" runat="server" type="text" autocomplete="off" disabled="disabled"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- /.box-body -->
                                                        ...
                                                        <fieldset>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <input class="form-control pull-right input-sm" id="txtConsigneeCode" runat="server" type="text" autocomplete="off" />
                                                                </div>
                                                                <div class="col-sm-2">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <input class="form-control pull-right input-sm" id="txtConsignneeEng" runat="server" type="text" autocomplete="off" />
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="txtConsignneeStreet_Number" class="col-sm-3 control-label">Address1</label>
                                                                <div class="col-md-8">
                                                                    <input class="form-control pull-right input-sm" id="txtConsignneeStreet_Number" runat="server" type="text" autocomplete="off" />
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="txtConsignneeDistrict" class="col-sm-3 control-label">Address2</label>
                                                                <div class="col-md-8">
                                                                    <input class="form-control pull-right input-sm" id="txtConsignneeDistrict" runat="server" type="text" autocomplete="off" />
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="txtConsignneeSubProvince" class="col-sm-3 control-label">Address3</label>
                                                                <div class="col-md-8">
                                                                    <input class="form-control pull-right input-sm" id="txtConsignneeSubProvince" runat="server" type="text" autocomplete="off" />
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="txtConsignneeProvince" class="col-sm-3 control-label">Address4</label>
                                                                <div class="col-md-8">
                                                                    <input class="form-control pull-right input-sm" id="txtConsignneeProvince" runat="server" type="text" autocomplete="off" />
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="txtConsignneePostCode" class="col-sm-3 control-label">Address5</label>
                                                                <div class="col-md-8">
                                                                    <input class="form-control pull-right input-sm" id="txtConsignneePostCode" runat="server" type="text" autocomplete="off" />
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="txtConsignneeEMail" class="col-sm-3 control-label">E-Mail</label>
                                                                <div class="col-md-8">
                                                                    <input class="form-control pull-right input-sm" id="txtConsignneeEMail" runat="server" type="text" autocomplete="off" />
                                                                </div>
                                                            </div>
                                                        </fieldset>
                                                    </div>
                                                        ...
                                                        <fieldset>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <input class="form-control pull-right input-sm" id="txtExporterCode" runat="server" type="text" autocomplete="off" />
                                                                </div>
                                                                <div class="col-md-2">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <input class="form-control pull-right input-sm" id="txtExportEng" runat="server" type="text" autocomplete="off" />
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="txtStreet_Number" class="col-sm-3 control-label">Address1</label>
                                                                <div class="col-md-8">
                                                                    <input class="form-control pull-right input-sm" id="txtStreet_Number" runat="server" type="text" autocomplete="off" />
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="txtDistrict" class="col-sm-3 control-label">Address2</label>
                                                                <div class="col-md-8">
                                                                    <input class="form-control pull-right input-sm" id="txtDistrict" runat="server" type="text" autocomplete="off" />
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="txtSubProvince" class="col-sm-3 control-label">Address3</label>
                                                                <div class="col-md-8">
                                                                    <input class="form-control pull-right input-sm" id="txtSubProvince" runat="server" type="text" autocomplete="off" />
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="txtProvince" class="col-sm-3 control-label">Address4</label>
                                                                <div class="col-md-8">
                                                                    <input class="form-control pull-right input-sm" id="txtProvince" runat="server" type="text" autocomplete="off" />
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="txtPostCode" class="col-sm-3 control-label">Address5</label>
                                                                <div class="col-md-8">
                                                                    <input class="form-control pull-right input-sm" id="txtPostCode" runat="server" type="text" autocomplete="off" />
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="txtCompensateCode" class="col-sm-3 control-label">Email</label>
                                                                <div class="col-md-8">
                                                                    <input class="form-control pull-right input-sm" id="txtCompensateCode" runat="server" type="text" autocomplete="off" />
                                                                </div>
                                                            </div>
                                                    ...
                                                    <fieldset>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <asp:DropDownList ID="txtCommodity" CssClass="form-control input-sm" runat="server" DataTextField="Code" DataValueField="Code"></asp:DropDownList>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="txtSubProvince" class="col-sm-4 control-label">Quantity PLT/Skid</label>
                                                                <div class="col-md-4">
                                                                    <input class="form-control pull-right input-sm" id="txtQuantityPLT" runat="server" type="text" autocomplete="off" />
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <asp:DropDownList ID="dcbQuantity2" CssClass="form-control input-sm" runat="server" DataTextField="Code" DataValueField="Code"></asp:DropDownList>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <input class="form-control pull-right input-sm" id="txtBox" runat="server" type="text" autocomplete="off" />
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <asp:DropDownList ID="cdbBox1" CssClass="form-control input-sm" runat="server" DataTextField="Code" DataValueField="Code"></asp:DropDownList>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="txtVolume" class="col-sm-4 control-label">Volume</label>
                                                                <div class="col-md-4">
                                                                    <input class="form-control pull-right input-sm" id="txtVolume" runat="server" type="text" autocomplete="off" />
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <asp:DropDownList ID="dcbVolume" CssClass="form-control input-sm" runat="server" DataTextField="Code" DataValueField="Code"></asp:DropDownList>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <div class="col-md-4">
                                                                    <asp:DropDownList ID="ComboBox7" CssClass="form-control input-sm" runat="server">
                                                                        <asp:ListItem></asp:ListItem>
                                                                ...
                                                                <div class="col-md-8">
                                                                    <input class="form-control pull-right input-sm" id="txtDocumentCode" runat="server" type="text" autocomplete="off" />
                                                                </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <input class="form-control pull-right input-sm" id="txtShipTo" runat="server" type="text" autocomplete="off" />
                                                                </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <input class="form-control pull-right input-sm" id="txtQuantityofPart" runat="server" type="text" autocomplete="off" />
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <asp:DropDownList ID="dcbQuantity1" CssClass="form-control input-sm" runat="server" DataTextField="Code" DataValueField="Code"></asp:DropDownList>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <input class="form-control pull-right input-sm" id="txtWeight" runat="server" type="text" autocomplete="off" />
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <asp:DropDownList ID="dcbWeight" CssClass="form-control input-sm" runat="server" DataTextField="Code" DataValueField="Code"></asp:DropDownList>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <input class="form-control pull-right input-sm" id="txtMAWB" runat="server" type="text" autocomplete="off" />
                                                                </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <input class="form-control pull-right input-sm" id="txtFlight" runat="server" type="text" autocomplete="off" />
                                                                </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <input class="form-control pull-right input-sm" id="txtFreigh" runat="server" type="text" autocomplete="off" />
                                                                </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <input class="form-control pull-right input-sm" id="txtBillingNo" runat="server" type="text" autocomplete="off" />
                                                                </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-10">
                                                                <input class="form-control pull-right input-sm" id="txtJobRemark" runat="server" type="text" autocomplete="off" />
                                                            </div>
                                                ...
                                                <div class="collg-12 col-md-12">
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-6">
                                                                 <asp:FileUpload ID="PathFile" runat="server" CssClass="form-control input-sm "/>
                                                                <%--<input class="form-control pull-right" id="txtPathFile" runat="server" type=" autocomplete="off" />--%>
                                                            </div>
                                                           <%-- <div class="col-md-4">
                                                            ...
                                                            <div class="col-md-6">
                                                               <%-- <input class="form-control pull-right" id="txtStatusFile" runat="server" type="text" autocomplete="off" />--%>
                                                                <asp:FileUpload ID="FileUpload1" CssClass="form-control" runat="server" Visible="false" />
                                                                 <input class="form-control pull-right input-sm" id="txtStatusFile" runat="server" type="text" autocomplete="off" />
                                                            </div>
                                                            <div class="col-md-4">
                                                                <asp:Button runat="server" ID="cmdOpenFile" Text="Open File" OnClick="cmdOpenFile_Click"/>
                                                ...
                                                <fieldset runat="server" id="detail_">
                                                    ...
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <input class="form-control pull-right input-sm" id="txtDOCode" runat="server" autocomplete="off" />
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtDONameENG" runat="server" autocomplete="off" />
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtDOStreet" runat="server" autocomplete="off" />
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtDODistrict" runat="server" autocomplete="off" />
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtDOSubProvince" runat="server" autocomplete="off" />
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtDOProvince" runat="server" autocomplete="off" />
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtDOPostCode" runat="server" autocomplete="off" />
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtDOEmail" runat="server" autocomplete="off" />
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtDOContactPerson" runat="server" autocomplete="off" />
                                                            </div>
                                                    ...
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <input class="form-control input-sm" id="txtCustomerCode" runat="server" />
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtCustomerENG" runat="server" autocomplete="off" />
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtCustomerStreet" runat="server" autocomplete="off" />
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtCustomerDistrict" runat="server" autocomplete="off" />
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtCustomerSub" runat="server" autocomplete="off" />
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtCustomerProvince" runat="server" autocomplete="off" />
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtCustomerPostCode" runat="server" autocomplete="off" />
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtCustomerEmail" runat="server" autocomplete="off" />
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtCustomerContact" runat="server" autocomplete="off" />
                                                            </div>
                                                    ...
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <input class="form-control input-sm" id="txtPickUpCode" runat="server" autocomplete="off" />
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtPickUpNameEng" runat="server" autocomplete="off" />
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtPickUpAddress1" runat="server" autocomplete="off" />
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtPickUpAddress2" runat="server" autocomplete="off" />
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtPickUpAddress3" runat="server" autocomplete="off" />
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtPickUpAddress4" runat="server" autocomplete="off" />
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtPickUpAddress5" runat="server" autocomplete="off" />
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtPickUpEmail" runat="server" autocomplete="off" />
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtPickUpContact" runat="server" autocomplete="off" />
                                                            </div>
                                                    ...
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <input class="form-control input-sm" id="txtEndCusCode" runat="server" autocomplete="off" />
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtEndCusNameEng" runat="server" autocomplete="off" />
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtEndCusAddress1" runat="server" autocomplete="off" />
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtEndCusAddress2" runat="server" autocomplete="off" />
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtEndCusAddress3" runat="server" autocomplete="off" />
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtEndCusAddress4" runat="server" autocomplete="off" />
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtEndCusAddress5" runat="server" autocomplete="off" />
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtEndCusEmail" runat="server" autocomplete="off" />
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtEndCusContact" runat="server" autocomplete="off" />
                                                            </div>
                                                        </div>
                                                    </fieldset>
                                                </div>
                                                    ...
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <input class="form-control input-sm" id="txtCustomerCodeGroup" runat="server" autocomplete="off" />
                                                            ...
                                                            <div class="col-md-2">
                                                                <button runat="server" class="btn btn-primary btn-sm" type="button" onserverclick="Unnamed_ServerClick7"><i class="fa fa-search"></i></button>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="txtCustomerENGGroup" class="col-sm-4 control-label">Name Group (Eng)</label>
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtCustomerENGGroup" runat="server" autocomplete="off" />
                                                            </div>
                                                        </div>
                                                    </fieldset>
                                                ...
                                                <fieldset runat="server" id="invoice_"> 
                                                    ...
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <input class="form-control input-sm" id="txtIEATNo" runat="server" disabled="disabled" />
                                                                <div class="checkbox">
                                                                    <label>
                                                            ...
                                                            <div class="col-sm-2">
                                                                <asp:Button runat="server" ID="Gen" Text="Gen" CssClass="btn btn-sm" OnClick="Gen_Click" />
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtIEATPermit" runat="server" autocomplete="off" />
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                ...
                                                                <div class="input-group date">
                                                                    ...
                                                                    <asp:TextBox CssClass="form-control input-sm" ID="txtIEATDate" runat="server" placeholder="MM/DD/YYYY">
                                                                    </asp:TextBox>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input class="form-control pull-right input-sm" id="txtEntryNo" runat="server" type="text" autocomplete="off" />
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-4">
                                                                <div class="input-group date">
                                                                    ...
                                                                    <asp:TextBox CssClass="form-control input-sm" ID="dtpDeliveryDate" runat="server" placeholder="MM/DD/YYYY">
                                                                    </asp:TextBox>
                                                                    <%--<input class="form-control pull-right" id="dtpIEATDate" runat="server" type="text" />--%>
                                                                </div>
                                                                ...
                                                                <div class="bootstrap-timepicker">
                                                                    <div class="form-group">
                                                                        <div class="input-group">
                                                                            <input type="text" class="form-control timepicker input-sm" runat="server" autocomplete="off" id="txtDeliveryTime"/>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <asp:DropDownList ID="dcbStatus1" CssClass="form-control input-sm" runat="server" DataTextField="Code" DataValueField="Code">
                                                                    <asp:ListItem></asp:ListItem>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <asp:DropDownList ID="dcbStatus2" CssClass="form-control input-sm" runat="server" DataTextField="Code" DataValueField="Code" OnSelectedIndexChanged="dcbStatus2_SelectedIndexChanged">
                                                                    <asp:ListItem></asp:ListItem>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <asp:DropDownList ID="dcbStatus3" CssClass="form-control input-sm" runat="server" DataTextField="Code" DataValueField="Code">
                                                                    <asp:ListItem></asp:ListItem>
                                                    ...
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <input class="form-control input-sm" id="txtEASInv" runat="server" autocomplete="off" />
                                                                <div class="checkbox">
                                                                    <label>
                                                            ...
                                                            <div class="col-sm-2">
                                                                <asp:Button runat="server" ID="Button2" Text="Gen" CssClass="btn btn-sm" OnClick="Button2_Click" />
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                ...
                                                                <input class="form-control input-sm" id="txtCustomerINV" runat="server" type="text" autocomplete="off" />
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <asp:DropDownList ID="txtRemark" CssClass="form-control input-sm" runat="server" DataTextField="Code" DataValueField="Code">
                                                                    <asp:ListItem></asp:ListItem>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtCancleIEAT" runat="server" autocomplete="off" />
                                                            </div>
                                                    ...
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtGenInvNo" runat="server" autocomplete="off" />
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-4">
                                                                <input class="form-control input-sm" id="txtQuantityDetail" runat="server" autocomplete="off" />
                                                            </div>
                                                            <div class="col-sm-4">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-4">
                                                                ...
                                                                <input class="form-control input-sm" id="txtPallet" runat="server" type="text" autocomplete="off" />

                                                            </div>
                                                            <div class="col-sm-4">
                                                                <asp:DropDownList ID="cdbUnitPallet" CssClass="form-control input-sm" runat="server" DataTextField="Code" DataValueField="Code"></asp:DropDownList>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-4">
                                                                ...
                                                                <input class="form-control input-sm" id="txtBoxINV" runat="server" type="text" autocomplete="off" />
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <asp:DropDownList ID="cdbBox" CssClass="form-control input-sm" runat="server" DataTextField="Code" DataValueField="Code"></asp:DropDownList>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="txtWeightInv" class="col-sm-3 control-label">Weight</label>
                                                            <div class="col-sm-4">
                                                                <input class="form-control pull-right input-sm" id="txtWeightInv" runat="server" type="text" autocomplete="off" />
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <asp:DropDownList ID="cdbUnitWeightInv" CssClass="form-control input-sm" runat="server" DataTextField="Code" DataValueField="Code"></asp:DropDownList>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                ...
                                                                <input class="form-control input-sm" id="txtPullS" runat="server" type="text" autocomplete="off" />
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-4">
                                                                <div class="input-group date">
                                                                    ...
                                                                    <asp:TextBox CssClass="form-control input-sm" ID="dtpInvoice" runat="server" placeholder="MM/DD/YYYY">
                                                                    </asp:TextBox>
                                                                    <%--<input class="form-control pull-right" id="dtpIEATDate" runat="server" type="text" />--%>
                                                                </div>
                                                            ...
                                                            <div class="col-sm-2">
                                                                <input class="form-control input-sm" id="txtItemNo" runat="server" type="text" autocomplete="off" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                ...
                                                                <input class="form-control input-sm" id="txtShipment" runat="server" type="text" autocomplete="off" />
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                ...
                                                                <input class="form-control input-sm" id="txtPriceBath" runat="server" type="text" autocomplete="off" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                ...
                                                                <input class="form-control input-sm" id="txtPriceForeign" runat="server" type="text" />
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="col-lg-12 col-md-12 " style="overflow: auto;">
                                            ...
                                            <asp:Repeater ID="dgvConsigneeCode" runat="server"  OnItemDataBound="dgvConsigneeCode_ItemDataBound">
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        <td class="text-center">
                                                            <asp:LinkButton ID="lnkPartyCode" CssClass="btn bg-navy btn-sm" runat="server" OnClick="lnkPartyCode_Click"><i class="fa fa-hand-o-up"></i></asp:LinkButton>
                                                        </td>
                                                        <td>
                                ...
                                <section class="content">
                                    <form class="form-horizontal">
                                        <div class="col-lg-12 col-md-12 " style="overflow: auto;">
                                            ...
                                            <asp:Repeater ID="dgvcodeconsignnee" runat="server" OnItemDataBound="dgvcodeconsignnee_ItemDataBound">
                                                <HeaderTemplate>
                                                ...
                                                <ItemTemplate>
                                                     <td class="text-center">
                                                            <asp:LinkButton ID="lnkPartyCode_code" CssClass="btn bg-navy btn-sm" runat="server" OnClick="lnkPartyCode_code_Click"><i class="fa fa-hand-o-up"></i></asp:LinkButton>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="lblPartyCode" runat="server" Text="Label"></asp:Label></td>
                                                        <td>
                                    ...
                                    <form class="form-horizontal">
                                        <div class="col-lg-12 col-md-12 " style="overflow: auto;">
                                            ...
                                            <asp:Repeater ID="dgvCustomer" runat="server"  OnItemDataBound="dgvCustomer_ItemDataBound">
                                                ...
                                                <ItemTemplate>
                                                    <td class="text-center">
                                                            <asp:LinkButton ID="lnkPartyCode_cus" CssClass="btn bg-navy btn-sm" runat="server" OnClick="lnkPartyCode_cus_Click"><i class="fa fa-hand-o-up"></i></asp:LinkButton>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="lblPartyCode" runat="server" Text="Label"></asp:Label></td>
                                                        <td>
                                ...
                                <section class="content">
                                    <form class="form-horizontal">
                                        <div class="col-lg-12 col-md-12 " style="overflow: auto;">
                                            ...
                                            <asp:Repeater ID="dgvPickUp" runat="server" OnItemDataBound="dgvPickUp_ItemDataBound">
                                                <HeaderTemplate>
                                                ...
                                                <ItemTemplate>
                                                    <td class="text-center">
                                                            <asp:LinkButton ID="lnkPartyCode_pick" CssClass="btn bg-navy btn-sm" runat="server" OnClick="lnkPartyCode_pick_Click"><i class="fa fa-hand-o-up"></i></asp:LinkButton>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="lblPartyCode" runat="server" Text="Label"></asp:Label></td>
                                                        <td>
                                ...
                                <section class="content">
                                    <form class="form-horizontal">
                                        <div class="col-lg-12 col-md-12 " style="overflow: auto;">
                                            ...
                                            <asp:Repeater ID="dgvEndCus" runat="server"  OnItemDataBound="dgvEndCus_ItemDataBound">
                                                <HeaderTemplate>
                                                ...
                                                <ItemTemplate>
                                                      <td class="text-center">
                                                            <asp:LinkButton ID="lnkPartyCode_End" CssClass="btn bg-navy btn-sm" runat="server" OnClick="lnkPartyCode_End_Click"><i class="fa fa-hand-o-up"></i></asp:LinkButton>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="lblPartyCode" runat="server" Text="Label"></asp:Label></td>
                                                        <td>
                                ...
                                <section class="content">
                                    <form class="form-horizontal">
                                        <div class="col-lg-12 col-md-12 " style="overflow: auto;">
                                            ...
                                            <asp:Repeater ID="dgvCustomerGroup" runat="server"  OnItemDataBound="dgvCustomerGroup_ItemDataBound">
                                                <HeaderTemplate>
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                       <td class="text-center">
                                                            <asp:LinkButton ID="lnkPartyCode_Group" CssClass="btn bg-navy btn-sm" runat="server" OnClick="lnkPartyCode_Group_Click"><i class="fa fa-hand-o-up"></i></asp:LinkButton>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="lblPartyCode" runat="server" Text="Label"></asp:Label></td>
