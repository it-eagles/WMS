<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RptCartonFrm.aspx.vb" Inherits="WMS.RptCartonFrm" MasterPageFile="~/Home.Master"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="RptCarton.aspx">Report Carton</a></li>
            ...
            <div class="col-lg-12 col-md-12 ">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Report Carton</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="row">
                            ...
                            <div class="col-lg-8 col-md-8 col-md-offset-2">
                                ...
                                <div class="form-group" >                                    
                                 ...
                                 <div class="form-group">
                                                ...
                                                <div class="radio">
                                                <label>                                            
                                                 <asp:RadioButton runat="server" ID ="rdbStock" Text="Stock"  onclick="EnableDisableTextBox();"  GroupName="option1" />
                                              </label>
                                               </div>            
                                           </div>
                                                ...
                                                <div class="radio">
                                                <label>                                            
                                                 <asp:RadioButton runat="server" ID ="rdbReceive" Text="Receive" onclick="EnableDisableTextBox();" GroupName="option1"/>
                                              </label>
                                               </div>            
                                           </div>     
    ...
    <!-- /.content -->
        ...
        <script type="text/javascript">
          function EnableDisableTextBox() {
              var status = document.getElementById('<%=rdbStock.ClientID%>').checked;
