...
Partial Public Class LKBWarehouseEntities1
    Inherits DbContext

    Public Sub New()
        MyBase.New("name=LKBWarehouseEntities1")
    End Sub
    ...
    Public Overridable Property tblCompanyGuarantee1() As DbSet(Of tblCompanyGuarantee1)
