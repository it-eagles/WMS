<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RptSumSeagateFrm.aspx.vb" Inherits="WMS.RptSumSeagateFrm" MasterPageFile="~/Home.Master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content-header">
        <h1>
            Report Summary Seagate
        </h1>
        <ol class="breadcrumb">
            <li><a href="HomeMain.aspx"><i class="fa fa-home"></i>Home</a></li>
            <li><a><i class="fa fa-file"></i>Report</a></li>     
            <li><a href="RptSumSeagate.aspx">Report Summary Seagate</a></li>
            ...
            <div class="col-lg-12 col-md-12 ">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Report Summary Seagate</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="row">
