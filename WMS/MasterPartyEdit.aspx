<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="MasterPartyEdit.aspx.vb" Inherits="WMS.MasterPartyEdit" MasterPageFile="~/Home.Master" %>
                                            ...
                                            <div class="form-horizontal">
                                                <div class="form-group" >
                                                    ...
                                                    <div class="col-md-6">
                                                         ...
                                                         <input class="form-control input-sm" id="txtPartyCode" runat="server" placeholder="Party Code" disabled="disabled" autocomplete="off"/>
                                                    </div>
                                                ...
                                                <div class="form-group" >
                                                    ...
                                                    <div class="col-md-9" id="ImpDesc1">
                                                        ...
                                                        <input class="form-control input-sm" id="txtFullName" runat="server" placeholder="Desc" autocomplete="off"/>
                                                    </div>
                                                </div> 
                                                <div class="form-group" >
