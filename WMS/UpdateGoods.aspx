<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="UpdateGoods.aspx.vb" MasterPageFile="~/Home.Master" Inherits="WMS.UpdateGoods" %>
                     ...
                     <div class="box-body">   
                         ...
                         <!--------- /.col-lg-6 col-md-6 ------------->           
                            ...
                            <div class="box-footer text-right">
                                    <button runat="server" class="btn btn-app" id="btneditGoods" title="btneditGoods" onserverclick="EditGoods_click"><i class="fa  fa-edit "></i> Edit</button>
                           </div>
                         </from>
                    </div>
                     <!---------- /.box box-primary  --------->
                                ...
                                <div class="form-group" >
                                    ...
                                    <div class="form-group">
                                        <label for="dcboImpBrand" class="col-sm-4 control-label">Brand :</label>
                                         <div class="col-sm-8">
                                             <asp:DropDownList ID="dcboImpBrand" CssClass="form-control" runat="server" DataTextField="Description" DataValueField="TypeID"></asp:DropDownList>
                                           </div>
                                     ...
                                     <div class="form-group" >
                                       ...
                                       <div class="col-md-4">
                                          ...
                                          <asp:DropDownList ID="cboImpCurrency" CssClass="form-control" runat="server" DataTextField="Code" DataValueField="TypeID"></asp:DropDownList>            
                                      </div>
 ...
 <!------- /. Import Goods ------->
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group" >
                                       ...
                                       <div class="col-md-4">
                                          ...
                                          <asp:DropDownList ID="cboExpCurrency" CssClass="form-control" runat="server" DataTextField="Code" DataValueField="TypeID"></asp:DropDownList>            
                                      </div>
                                ...
                                <div class="col-lg-6 col-md-6">
                                  <div class="form-group">
                                   ...
                                   <div class="col-md-8">
                                         ...
                                         <asp:DropDownList ID="cboProductUnit" CssClass="form-control" runat="server" DataTextField="Code" DataValueField="TypeID"></asp:DropDownList>
                                   </div>
                            ...
                            <legend>Pallet Dimension</legend>
                                 <div class="col-lg-6 col-md-6">
                                  <div class="form-group">
                                   ...
                                   <div class="col-md-8">
                                         ...
                                         <asp:DropDownList ID="cboPackageUnit" CssClass="form-control" runat="server" DataTextField="Code" DataValueField="TypeID"></asp:DropDownList>
                                   </div>
                             ...
                             <div class="col-lg-12 col-md-12">
                                  <div class="form-group">
                                   ...
                                   <div class="col-md-4">
                                        <asp:DropDownList ID="cboPackageofUnit" CssClass="form-control" runat="server" DataTextField="Code" DataValueField="TypeID"></asp:DropDownList>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="form-group" >
                                       ...
                                       <div class="col-md-6">
                                            ...
                                            <asp:DropDownList ID="cdbGroupGoods" CssClass="form-control" runat="server"  DataTextField="Description" DataValueField="TypeID"></asp:DropDownList>
                                      </div>
                ...
                <div id="radio2">
                    <div class="row" >
                      ...
                      <div class="form-group">
                                      ...
                                      <div class="col-sm-6">
                                           <input class="form-control" id="txtNoCodeGoods" name="txtNoCodeGoods" runat="server"  placeholder="Name" disabled>
                                       </div>
                                         <div class="col-md-3">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-6">
                                           <input class="form-control" id="txtCodeSize" runat="server"  placeholder="Name" disabled>
                                      </div>
                                    ...
                                    <div class="form-group" >
                                       ...
                                       <div class="col-md-3">
                                             <input class="form-control" id="txtCodeColor" runat="server" placeholder="Group" disabled>
                                        </div>
                                    </div>
                                    <!-- /.box-body -->
                             </div>
    ...
    <!-- /.content -->
        ...
        <div class="modal-footer">
         <button type="submit" runat="server" class="btn btn-primary" id="btnAddUser" title="btnAddUser" >Submit</button>
