...
Public Class AddUser
    ...
    Private Sub SaveDATA_New()
        ...
        End If
            ...
            Try
                Dim user = (From u In db.tblUser Where u.UserName = txtUserName.Value
        ...
        Using tran As New TransactionScope()
                ...
                Try
                    ...
                    db.tblUser.Add(New tblUser With { _
                                 ...
                                 .UserGroupID = CType(dcboUserGroup.Text.Trim, Integer?), _
                                 .DepartmentID = CType(dcbDept.Text, Integer?), _
                                 .BranchID = CType(dcbBranch.Text.Trim, Integer?), _
    ...
    Private Sub checkID()
        ...
        Dim Key As String = "log-" + Mid(CStr(Now.Year), 3) + (CStr(Format(Now.Date, "MM")))
            ...
            Dim id = (From log In db.tblRunningNumber Where log.Name = Key Select log).FirstOrDefault
