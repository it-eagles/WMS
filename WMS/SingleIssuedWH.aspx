<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SingleIssuedWH.aspx.vb" Inherits="WMS.SingleIssuedWH" MasterPageFile="~/Home.Master" EnableEventValidation="false" EnableViewState="true"%>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="bootstrap-timepicker">
                                                <div class="input-group">
                                                    <input type="text" class="form-control timepicker input-sm" runat="server" id="txtTimePickUpPullDateTime" autocomplete="off" />
                                ...
                                <div class="form-horizontal">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="bootstrap-timepicker">
                                                <div class="input-group">
                                                    <input type="text" class="form-control timepicker input-sm" runat="server" id="txtTimePickUpDeliveryDateTime" autocomplete="off" />
                                                    <div class="input-group-addon">
                                                        <i class="fa fa-clock-o"></i>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="bootstrap-timepicker">
                                                <div class="input-group">
                                                    <input type="text" class="form-control timepicker input-sm" runat="server" id="txtTimePickUpConfirmDateTime" autocomplete="off" />
                                                    <div class="input-group-addon">
                                                        <i class="fa fa-clock-o"></i>
                                                    </div>
                                                </div>
            ...
            <div class="panel panel-default">
                    <div id="Tabs" role="tabpanel" class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#issuecondition" role="tab" data-toggle="tab">Issue Condition</a></li>
                            <li><a href="#confirmissue" role="tab" data-toggle="tab">Confirm Issue</a></li>
                        </ul>
                        ...
                        <div class="tab-content">
                            ...
                            <!------- Import Goods ------->
                            <div class="active tab-pane" role="tabpanel" id="issuecondition">
                                                    ...
                                                    <div class="box-body">
                                                        <div class="col-md-4 col-sm-4">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input class="form-control input-sm" id="txtJobNo_IssueCon" runat="server" autocomplete="off"/>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <div class="col-sm-4">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input class="form-control input-sm" id="txtCustRefNo_IssueCon" runat="server" autocomplete="off"/>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <div class="col-sm-4">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <button type="submit" runat="server" class="btn btn-primary btn-sm" id="btnRejectMoveTo_IssueCon" title="btnRejectMoveTo_IssueCon" onserverclick="btnRejectMoveTo_IssueCon_ServerClick">Reject MoveTo</button>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <asp:DropDownList ID="ddlWHSite_IssueCon" CssClass="form-control input-sm" runat="server"></asp:DropDownList>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <fieldset>
                                                    ...
                                                    <div class="box-body">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <input class="form-control input-sm" id="txtExporterCode_IssueCon" runat="server" autocomplete="off"/>
                                                            </div>
                                                            <div class="col-sm-2">
                                                                <button type="button" class="btn btn-primary btn-sm" runat="server" id="btnExporterCode_IssueCon" onserverclick="btnExporterCode_IssueCon_ServerClick"><i class="glyphicon glyphicon-search"></i></button>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="txtNameExporter_IssueCon" class="col-sm-4 control-label">Name:</label>
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtNameExporter_IssueCon" runat="server" autocomplete="off"/>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="txtAddress1Exporter_IssueCon" class="col-sm-4 control-label">Address1:</label>
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtAddress1Exporter_IssueCon" runat="server" autocomplete="off"/>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="txtAddress2Exporter_IssueCon" class="col-sm-4 control-label">Address2:</label>
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtAddress2Exporter_IssueCon" runat="server" autocomplete="off"/>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="txtAddress3Exporter_IssueCon" class="col-sm-4 control-label">Address3:</label>
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtAddress3Exporter_IssueCon" runat="server" autocomplete="off"/>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="txtAddress4Exporter_IssueCon" class="col-sm-4 control-label">Address4:</label>
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtAddress4Exporter_IssueCon" runat="server" autocomplete="off"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- /.box-body -->
                                                ...
                                                <fieldset>
                                                    ...
                                                    <div class="box-body">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <input class="form-control input-sm" id="txtOwnerCode_IssueCon" runat="server" autocomplete="off"/>
                                                            </div>
                                                            <div class="col-sm-2">
                                                                <button type="button" class="btn btn-primary btn-sm" runat="server" id="btnOwnerCode_IssueCon" onserverclick="btnOwnerCode_IssueCon_ServerClick"><i class="glyphicon glyphicon-search"></i></button>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="txtNameOwner_IssueCon" class="col-sm-4 control-label">Name:</label>
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtNameOwner_IssueCon" runat="server" autocomplete="off"/>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="txtAddress1Owner_IssueCon" class="col-sm-4 control-label">Address1:</label>
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtAddress1Owner_IssueCon" runat="server" autocomplete="off"/>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="txtAddress2Owner_IssueCon" class="col-sm-4 control-label">Address2:</label>
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtAddress2Owner_IssueCon" runat="server" autocomplete="off"/>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="txtAddress3Owner_IssueCon" class="col-sm-4 control-label">Address3:</label>
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtAddress3Owner_IssueCon" runat="server" autocomplete="off"/>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="txtAddress4Owner_IssueCon" class="col-sm-4 control-label">Address4:</label>
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtAddress4Owner_IssueCon" runat="server" autocomplete="off"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- /.box-body -->
                                                ...
                                                <fieldset>
                                                    ...
                                                    <div class="box-body">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <asp:DropDownList ID="ddlCommodity_IssueCon" CssClass="form-control input-sm" runat="server"></asp:DropDownList>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="txtQuantityPackage_IssueCon" class="col-sm-5 control-label">Quantity Package:</label>
                                                            <div class="col-sm-3">
                                                                <input class="form-control input-sm" id="txtQuantityPackage_IssueCon" runat="server"  autocomplete="off" />
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <asp:DropDownList ID="ddlQuantityPackage_IssueCon" CssClass="form-control input-sm" runat="server"></asp:DropDownList>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="txtQuantityPLTSkid_IssueCon" class="col-sm-5 control-label">Quantity PLT/Skid:</label>
                                                            <div class="col-sm-3">
                                                                <input class="form-control input-sm" id="txtQuantityPLTSkid_IssueCon" runat="server"  autocomplete="off" />
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <asp:DropDownList ID="ddlQuantityPLTSkid_IssueCon" CssClass="form-control input-sm" runat="server"></asp:DropDownList>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="txtQuantityPicked_IssueCon" class="col-sm-5 control-label">Quantity Picked:</label>
                                                            <div class="col-sm-3">
                                                                <input class="form-control input-sm" id="txtQuantityPicked_IssueCon" runat="server" autocomplete="off" />
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <asp:DropDownList ID="ddlQuantityPicked_IssueCon" CssClass="form-control input-sm" runat="server"></asp:DropDownList>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="txtRemark_IssueCon" class="col-sm-4 control-label">Remark:</label>
                                                            <div class="col-sm-8">
                                                                <textarea class="form-control input-sm" rows="3" runat="server" id="txtRemark_IssueCon" placeholder="Remark" style="height: 71px; width: 872px;" autocomplete="off"></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="col-sm-4">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <button type="submit" runat="server" class="btn btn-primary btn-sm" id="btnSumQTY_IssueCon" title="btnSumQTY_IssueCon" onserverclick="btnSumQTY_IssueCon_ServerClick">Sum QTY</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- /.box-body -->
                                                ...
                                                <fieldset>
                                                    ...
                                                    <div class="box-body">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <input class="form-control input-sm" id="txtConsigneeCode01_IssueCon" runat="server" placeholder="Job No" autocomplete="off" />
                                                            </div>
                                                            <div class="col-sm-2">
                                                                <button type="button" class="btn btn-primary btn-sm" runat="server" id="btnConsigneeCode_IssueCon" onserverclick="btnConsigneeCode_IssueCon_ServerClick"><i class="glyphicon glyphicon-search"></i></button>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="txtNameConsignee_IssueCon" class="col-sm-4 control-label">Name:</label>
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtNameConsignee_IssueCon" runat="server" autocomplete="off" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="txtAddress1Consignee_IssueCon" class="col-sm-4 control-label">Address1:</label>
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtAddress1Consignee_IssueCon" runat="server" autocomplete="off" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="txtAddress2Consignee_IssueCon" class="col-sm-4 control-label">Address2:</label>
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtAddress2Consignee_IssueCon" runat="server" autocomplete="off" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="txtAddress3Consignee_IssueCon" class="col-sm-4 control-label">Address3:</label>
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtAddress3Consignee_IssueCon" runat="server" autocomplete="off" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="txtAddress4Consignee_IssueCon" class="col-sm-4 control-label">Address4:</label>
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtAddress4Consignee_IssueCon" runat="server" autocomplete="off" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- /.box-body -->
                                                ...
                                                <fieldset>
                                                    ...
                                                    <div class="box-body">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <input class="form-control input-sm" id="txtShipToCode_IssueCon" runat="server" placeholder="Ship No" autocomplete="off" />
                                                            </div>
                                                            <div class="col-sm-2">
                                                                <button type="button" class="btn btn-primary btn-sm" runat="server" id="btnShipToCode_IssueCon" onserverclick="btnShipToCode_IssueCon_ServerClick"><i class="glyphicon glyphicon-search"></i></button>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="txtNameShipTo_IssueCon" class="col-sm-4 control-label">Name:</label>
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtNameShipTo_IssueCon" runat="server" autocomplete="off" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="txtAddress1ShipTo_IssueCon" class="col-sm-4 control-label">Address1:</label>
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtAddress1ShipTo_IssueCon" runat="server" autocomplete="off" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="txtAddress2ShipTo_IssueCon" class="col-sm-4 control-label">Address2:</label>
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtAddress2ShipTo_IssueCon" runat="server" autocomplete="off" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="txtAddress3ShipTo_IssueCon" class="col-sm-4 control-label">Address3:</label>
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtAddress3ShipTo_IssueCon" runat="server" autocomplete="off" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="txtAddress4ShipTo_IssueCon" class="col-sm-4 control-label">Address4:</label>
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtAddress4ShipTo_IssueCon" runat="server" autocomplete="off" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- /.box-body -->
                                                ...
                                                <fieldset>
                                                    ...
                                                    <div class="box-body">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-3">
                                                                <input class="form-control input-sm" id="txtQuantityOfGood_IssueCon" runat="server"  autocomplete="off" />
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <asp:DropDownList ID="ddlQuantityOfGood_IssueCon" CssClass="form-control input-sm" runat="server"></asp:DropDownList>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="txtWeight_IssueCon" class="col-sm-5 control-label">Weight:</label>
                                                            <div class="col-sm-3">
                                                                <input class="form-control input-sm" id="txtWeight_IssueCon" runat="server"  autocomplete="off" />
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <asp:DropDownList ID="ddlWeight_IssueCon" CssClass="form-control input-sm" runat="server"></asp:DropDownList>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="txtVolume_IssueCon" class="col-sm-5 control-label">Volume:</label>
                                                            <div class="col-sm-3">
                                                                <input class="form-control input-sm" id="txtVolume_IssueCon" runat="server"  autocomplete="off" />
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <asp:DropDownList ID="ddlVolume_IssueCon" CssClass="form-control input-sm" runat="server"></asp:DropDownList>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="txtQTYDiscrepancy_IssueCon" class="col-sm-5 control-label">QTY Discrepancy:</label>
                                                            <div class="col-sm-3">
                                                                <input class="form-control input-sm" id="txtQTYDiscrepancy_IssueCon" runat="server"  autocomplete="off" />
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <asp:DropDownList ID="ddlQTYDiscrepancy_IssueCon" CssClass="form-control input-sm" runat="server"></asp:DropDownList>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-4">
                                                                <button type="submit" runat="server" class="btn btn-primary btn-sm" id="btnConfirmIssued_IssueCon" title="btnConfirmIssued_IssueCon" onserverclick="btnConfirmIssued_IssueCon_ServerClick">Confirm Issued</button>
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <button type="submit" runat="server" class="btn btn-primary btn-sm" id="btnRejectConfirm_IssueCon" title="btnRejectConfirm_IssueCon" onserverclick="btnRejectConfirm_IssueCon_ServerClick">Reject Confirm</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- /.box-body -->
                            ...
                            <%--------------------------------------------------------------Start Confirm Issue----------------------------------------------------------%>
                            <!-------- Export Goods --------->
                            <div class="tab-pane" role="tabpanel" id="confirmissue">
                                                ...
                                                <div class="box-body">
                                                    <div class="col-md-4 col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <asp:DropDownList ID="ddlWHSite_ConfirmIssue" CssClass="form-control input-sm" runat="server"></asp:DropDownList>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="txtCusLOTNo_ConfirmIssue" class="col-sm-4 control-label">Cus LOT No:</label>
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtCusLOTNo_ConfirmIssue" runat="server" autocomplete="off" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="txtEASPN_ConfirmIssue" class="col-sm-4 control-label">EAS P/N:</label>
                                                            <div class="col-sm-5">
                                                                <input class="form-control input-sm" id="txtEASPN_ConfirmIssue" runat="server" autocomplete="off" />
                                                            </div>
                                                            <div class="col-sm-3">
                                                                <button type="button" class="btn btn-primary btn-sm" runat="server" id="btnEASPN_ConfirmIssue" onserverclick="btnEASPN_ConfirmIssue_ServerClick"><i class="glyphicon glyphicon-search"></i></button>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="txtProductDesc_ConfirmIssue" class="col-sm-4 control-label">Product Desc:</label>
                                                            <div class="col-sm-8">
                                                                <textarea class="form-control input-sm" rows="3" runat="server" id="txtProductDesc_ConfirmIssue" placeholder="Desc .." style="height: 34px; width: 552px;" autocomplete="off"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <asp:DropDownList ID="ddlWHLocation_ConfirmIssue" CssClass="form-control input-sm" runat="server"></asp:DropDownList>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="txtCustWHFac_ConfirmIssue" class="col-sm-4 control-label">Cust W/H Fac:</label>
                                                            <div class="col-sm-8">
                                                                <asp:DropDownList ID="ddlCustWHFac_ConfirmIssue" CssClass="form-control input-sm" runat="server"></asp:DropDownList>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="txtCustomerPN_ConfirmIssue" class="col-sm-4 control-label">CustomerP/N:</label>
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtCustomerPN_ConfirmIssue" runat="server" autocomplete="off" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtENDCustomer_ConfirmIssue" runat="server" autocomplete="off" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="txtItemNo_ConfirmIssue" class="col-sm-4 control-label">Item No:</label>
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtItemNo_ConfirmIssue" runat="server" autocomplete="off" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="txtOwnerPN_ConfirmIssue" class="col-sm-4 control-label">Owner P/N:</label>
                                                            <div class="col-sm-8">
                                                                <input class="form-control input-sm" id="txtOwnerPN_ConfirmIssue" runat="server" autocomplete="off" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="txtMeasurement_ConfirmIssue" class="col-sm-4 control-label">Measurement:</label>
                                                            <div class="col-sm-8">
                                                                <asp:DropDownList ID="ddlMeasurement_ConfirmIssue" CssClass="form-control input-sm" runat="server"></asp:DropDownList>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="form-horizontal">
                                                ...
                                                <div class="box-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <input class="form-control input-sm" id="txtWidth_ConfirmIssue" runat="server"  autocomplete="off"/>
                                                        </div>
                                                        <div class="col-sm-4">
                                                            <input class="form-control input-sm" id="txtHight_ConfirmIssue" runat="server"  autocomplete="off" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="txtOrderNo_ConfirmIssue" class="col-sm-4 control-label">Order No:</label>
                                                        <div class="col-sm-8">
                                                            <input class="form-control input-sm" id="txtOrderNo_ConfirmIssue" runat="server" autocomplete="off" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="txtReceiveNo_ConfirmIssue" class="col-sm-4 control-label">Receive No:</label>
                                                        <div class="col-sm-8">
                                                            <input class="form-control input-sm" id="txtReceiveNo_ConfirmIssue" runat="server"  autocomplete="off"/>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="col-sm-4">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <asp:TextBox CssClass="form-control input-sm" ID="txtdatepickerManufacturing_ConfirmIssue" runat="server" placeholder="DD/MM/YYYY" autocomplete="off">
                                                            </asp:TextBox>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <asp:TextBox CssClass="form-control input-sm" ID="txtdatepickerReceiveDate_ConfirmIssue" runat="server" placeholder="DD/MM/YYYY" autocomplete="off">
                                                            </asp:TextBox>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <input class="form-control input-sm" id="txtQuantity_ConfirmIssue" runat="server" autocomplete="off"/>
                                                        </div>
                                                        <div class="col-sm-4">
                                                            <asp:DropDownList ID="ddlQuantity_ConfirmIssue" CssClass="form-control input-sm" runat="server"></asp:DropDownList>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="txtCurrency_ConfirmIssue" class="col-sm-4">Currency:</label>
                                                        <label for="txtPriceForeign_ConfirmIssue" class="col-sm-4">Price Foreign:</label>
                                                        <label for="txtPriceBath_ConfirmIssue" class="col-sm-4">Price Bath:</label>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="col-sm-4">
                                                            <asp:DropDownList ID="ddlCurrency_ConfirmIssue" CssClass="form-control input-sm" runat="server"></asp:DropDownList>
                                                        </div>
                                                        <div class="col-sm-4">
                                                            <input class="form-control input-sm" id="txtPriceForeign_ConfirmIssue" runat="server"  autocomplete="off" />
                                                        </div>
                                                        <div class="col-sm-4">
                                                            <input class="form-control input-sm" id="txtPriceBath_ConfirmIssue" runat="server" autocomplete="off" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- /.box-body -->
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-horizontal">
                                                ...
                                                <div class="box-body">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-sm-4">
                                                            <input class="form-control input-sm" id="txtLength_ConfirmIssue" runat="server" autocomplete="off" />
                                                        </div>
                                                        <div class="col-sm-4">
                                                            <input class="form-control input-sm" id="txtProductVolume_ConfirmIssue" runat="server"  autocomplete="off" />
                                                        </div>
                                                        <div class="col-sm-4">
                                                            <input class="form-control input-sm" id="txtPalletNo_ConfirmIssue" runat="server"  autocomplete="off" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="txtStatus_ConfirmIssue" class="col-sm-4 control-label">Status:</label>
                                                        <div class="col-sm-8">
                                                            <asp:DropDownList ID="ddlStatus_ConfirmIssue" CssClass="form-control input-sm" runat="server">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <asp:DropDownList ID="ddlType_ConfirmIssue" CssClass="form-control input-sm" runat="server">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <asp:TextBox CssClass="form-control input-sm" ID="txtdatepickerExpiredDate_ConfirmIssue" runat="server" placeholder="DD/MM/YYYY">
                                                            </asp:TextBox>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <input class="form-control input-sm" id="txtPONo_ConfirmIssue" runat="server" autocomplete="off" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="txtWeight_ConfirmIssue" class="col-sm-4 control-label">Weight:</label>
                                                        <div class="col-sm-4">
                                                            <input class="form-control input-sm" id="txtWeight_ConfirmIssue" runat="server"  autocomplete="off" />
                                                        </div>
                                                        <div class="col-sm-4">
                                                            <asp:DropDownList ID="ddlWeight_ConfirmIssue" CssClass="form-control input-sm" runat="server"></asp:DropDownList>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-sm-4">
                                                            <input class="form-control input-sm" id="txtExchangeRate_ConfirmIssue" runat="server" autocomplete="off" />
                                                        </div>
                                                        <div class="col-sm-4">
                                                            <input class="form-control input-sm" id="txtAmount_ConfirmIssue" runat="server"  autocomplete="off" />
                                                        </div>
                                                        <div class="col-sm-4">
                                                            <input class="form-control input-sm" id="txtBathAmount_ConfirmIssue" runat="server" autocomplete="off" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- /.box-body -->
                                                ...
                                                <div class="box-body">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-3">
                                                                <button type="submit" runat="server" class="btn btn-primary btn-sm" id="btnCencelSelectAll_ConfirmIssue" title="btnCencelSelectAll_ConfirmIssue">Cencel Select All</button>
                                                            </div>--%>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label for="txtWHLocation_ConfirmIssue" class="col-sm-4 control-label">WH Location:</label>
                                                            <div class="col-sm-4">
                                                                <input class="form-control input-sm" id="txtWHLocation_ConfirmIssue" runat="server" autocomplete="off" />
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <button type="submit" runat="server" class="btn btn-primary btn-sm" id="btnIssue_ConfirmIssue" onserverclick="btnIssue_ConfirmIssue_ServerClick" title="btnIssue_ConfirmIssue">Issue</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-12">
                                                      ...
                                                      <asp:Repeater ID="Repeater9" runat="server" OnItemCommand="Repeater9_ItemCommand">
                                                            ...
                                                            <ItemTemplate>
                                                                <tr>
                                                                    <td class="text-center">
                                                                        <asp:LinkButton ID="LinkButton2" CssClass="btn bg-navy  btn-sm" runat="server" CausesValidation="False" CommandName="Selectdataissueddetail" CommandArgument='<%# Eval("ItemNo")%>'><i class="fa fa-hand-o-up"></i></asp:LinkButton>
                                                                    </td>
                                                                    <td>
                                        ...
                                        <div class="col-lg-12 col-md-12 " style="overflow: auto;">
                                            <asp:Repeater ID="Repeater1" runat="server" OnItemDataBound="Repeater1_ItemDataBound">
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        <td class="text-center">
                                                            <asp:LinkButton ID="LinkButton3" CssClass="btn bg-navy btn-sm" runat="server" OnClick="clickexporter_Click"><i class="fa fa-hand-o-up"></i></asp:LinkButton>
                                                        </td>
                                                        <td>
                                        ...
                                        <div class="col-lg-12 col-md-12 " style="overflow: auto;">
                                            <asp:Repeater ID="Repeater2" runat="server" OnItemDataBound="Repeater2_ItemDataBound">
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        <td class="text-center">
                                                            <asp:LinkButton ID="LinkButton3" CssClass="btn bg-navy btn-sm" runat="server" OnClick="clickowner_Click"><i class="fa fa-hand-o-up"></i></asp:LinkButton>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="lblPartyCode" runat="server" Text="Label"></asp:Label></td>
                                                        <td>
                                        ...
                                        <div class="col-lg-12 col-md-12 " style="overflow: auto;">
                                            <asp:Repeater ID="Repeater3" runat="server" OnItemDataBound="Repeater3_ItemDataBound">
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        <td class="text-center">
                                                            <asp:LinkButton ID="LinkButton2" CssClass="btn bg-navy btn-sm" runat="server" OnClick="clickconsignee_Click"><i class="fa fa-hand-o-up"></i></asp:LinkButton>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="lblPartyCode" runat="server" Text="Label"></asp:Label></td>
                                                        <td>
                                        ...
                                        <div class="col-lg-12 col-md-12 " style="overflow: auto;">
                                            <asp:Repeater ID="Repeater4" runat="server" OnItemDataBound="Repeater4_ItemDataBound">
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        <td class="text-center">
                                                            <asp:LinkButton ID="LinkButton2" CssClass="btn bg-navy btn-sm" runat="server" OnClick="clickshipto_Click"><i class="fa fa-hand-o-up"></i></asp:LinkButton>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="lblPartyCode" runat="server" Text="Label"></asp:Label></td>
                                                        <td>
                                        ...
                                        <div class="col-lg-12 col-md-12 " style="overflow: auto;">
                                            <asp:Repeater ID="Repeater6" runat="server" OnItemCommand="Repeater6_ItemCommand">
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        <td class="text-center">
                                                            <asp:LinkButton ID="LinkButton2" CssClass="btn bg-navy btn-sm" runat="server" CausesValidation="False" CommandName="Selectjobnoadd" CommandArgument='<%# Eval("LOTNo")%>'><i class="fa fa-hand-o-up"></i></asp:LinkButton>
                                                        </td>
                                                        <td>
                                        ...
                                        <div class="col-lg-12 col-md-12 " style="overflow: auto;">
                                            <asp:Repeater ID="Repeater7" runat="server" OnItemCommand="Repeater7_ItemCommand">
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        <td class="text-center">
                                                            <asp:LinkButton ID="LinkButton2" CssClass="btn bg-navy btn-sm" runat="server" CausesValidation="False" CommandName="Selectjobnoedit" CommandArgument='<%# Eval("LOTNo")%>'><i class="fa fa-hand-o-up"></i></asp:LinkButton>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="lblPartyCode" runat="server" Text='<%# Bind("LOTNo")%>'></asp:Label></td>
                                                        <td>
