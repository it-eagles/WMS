                                            ...
                                            <div class="col-sm-3">
                                                <div class="checkbox">
                                                    <label class="control-label">
                                                        <input type="checkbox" runat="server" id="chkRCVDNo_BeforeTab" onclick="EnableDisablechkGen();" />
                                                        RCVD No
                                                    </label>
                                                </div>
                                            </div>
                                                        ...
                                                        <asp:Repeater ID="Repea1_Itemdetail" runat="server" OnItemCommand="Repea1_Itemdetail_ItemCommand">
                                                            ...
                                                            <ItemTemplate>
                                                                <tr class="success">
                                                                    ...
                                                                    <td>
                                                                        <asp:Label ID="Label8" runat="server" Text='<%# Bind("InvoiceNo")%>'></asp:Label></td>
                                                                    <td>
                                                                        <asp:Label ID="lblJobSite" runat="server" Text='<%# Bind("ItemNo")%>'></asp:Label></td>
                                                                    <td>
                                                                        <asp:Label ID="Label1" runat="server" Text='<%# Bind("Product")%>'></asp:Label></td>
                                                                    <td>
                                                                        <asp:Label ID="Label2" runat="server" Text='<%# Bind("Productyear")%>'></asp:Label></td>
                                                                    <td>
                                                                        <asp:Label ID="Label5" runat="server" Text='<%# Bind("Brand")%>'></asp:Label></td>
                                                                    <td>
                                                                        <asp:Label ID="Label4" runat="server" Text='<%# Bind("NatureofTrn")%>'></asp:Label></td>
                                                                    <td>
                                                                        <asp:Label ID="Label6" runat="server" Text='<%# Bind("PurchaseCountry")%>'></asp:Label></td>
                                                                    <td>
                                                                        <asp:Label ID="Label7" runat="server" Text='<%# Bind("OriginCountry")%>'></asp:Label></td>
                                                                </tr>
                                                            </ItemTemplate>
