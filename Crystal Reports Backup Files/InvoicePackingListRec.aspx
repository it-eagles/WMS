                ...
                <div class="col-md-12">
                    ...
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">                            
                            ...
                            <li><a href="#easjob" data-toggle="tab">EAS Job</a></li>
                            <li><a href="#itemdetail" data-toggle="tab">Item Detail</a></li>
                            <li><a href="#packinglist" data-toggle="tab">Packing List</a></li>
                        </ul>
          ...
          <!--/.col-lg-6 col-md-6 stockqty--->
            ...
            <!-----/ Export Goods----->
              ...
              <%--------------------------------------------------------------END ITEM DETAIL----------------------------------------------------------%>
               ...
               <%--------------------------------------------------------------Start Packing List----------------------------------------------------------%>
       <!-------- Export Goods --------->
     <div class="tab-pane" id="packinglist">
                                <!-- Post -->
        <div class="row">
