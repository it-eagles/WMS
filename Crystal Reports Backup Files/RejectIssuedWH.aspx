<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RejectIssuedWH.aspx.vb" Inherits="WMS.RejectIssuedWH" MasterPageFile="~/Home.Master"  %>
                                                   ...
                                                   <%--<fieldset>  <legend>Job</legend>--%>
                                                      <div class="box-body">   
                                                          <div class="col-sm-6">
                                                              <div class="form-group">
                                                                  <div class="col-sm-4">                                                                    
                                                                    <button type="submit" runat="server" class="btn btn-primary" id="btnSelectAll" title="btnSelectAll" >Select All</button>                                                                    
                                                                  </div>
                                                                  <div class="col-sm-4">                                                                    
                                                                    <button type="submit" runat="server" class="btn btn-primary" id="btnCencelSelectAll" title="btnCencelSelectAll" >Cencel Select All</button>                                                                    
                                                                  </div> 
                                                              </div>
                                                          </div>
                                                          ...
                                                          <div class="col-sm-6">
                                                              <div class="form-group">
                                                                  <div class="col-sm-4">                                                                    
                                                                    <button type="submit" runat="server" class="btn btn-primary" id="btnDelete" title="btnDelete" >Delete</button>                                                                    
                                                                  </div>
                                                              </div>
                                                          </div>
