            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">     
                            <label for="txtPullDateTime" class="col-sm-4 control-label">Pull Date/Time:</label>                       
                            <div class="col-sm-4">                                            
            ...
            <div class="form-horizontal">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input class="form-control" id="txtPickQTY_ConfirmIssue" runat="server" value="0"/>
                  </div>
                  <div class="col-sm-4">                    
            ...
            <div class="form-horizontal">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">                       
                      <input class="form-control" id="txtIssueQTY_ConfirmIssue" runat="server" value="0"/>
                  </div>
                </div> 
                 <div class="form-group">
